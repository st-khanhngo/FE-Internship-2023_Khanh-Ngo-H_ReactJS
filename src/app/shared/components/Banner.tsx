  ...
  return (
    ...
    <div className="container">
      <div className="section-header">
        <h2 className="section-title">Sale of the
          ...
          <li className="note-item">
            <div className="note flex">
              ...
              <div className="note-content">
                ...
                <p className="note-desc txt-secondary">Our clients opinions speak for themselves</p>
              </div>
            </div>
          </li>
          <li className="note-item">
            <div className="note flex">
              ...
              <div className="note-content">
                ...
                <p className="note-desc txt-secondary">30 days warranty for each product from our store</p>
              </div>
            </div>
          </li>
        </ul>
