...
const Footer = () => {
  return (
    ...
    <div className="container">
      <div className="footer-content row">
        <div className="footer-detail col col-6 col-sm-12">
          ...
          <p className="footer-detail-desc">House My Brand designs clothing for the young, the old &everyone in between –
            but most importantly, for the fashionable</p>
        ...
        <ul className="footer-nav col col-6 row">
          <li className="footer-nav-col col col-4 col-sm-12">
            ...
            <ul className="footer-nav-list">
              <li className="item">
                <a className="link" href="">Order Status</a>
              </li>
              <li className="item">
                <a className="link" href="">Shipping and Delivery</a>
              </li>
              <li className="item">
                <a className="link" href="">Returns</a>
              </li>
              <li className="item">
                <a className="link" href="">Order Status</a>
              </li>
          ...
          <li className="footer-nav-col col col-4 col-sm-12">
            ...
            <ul className="footer-nav-list">
              ...
              <li className="item">
                <a className="link" href="">Become a mesmer</a>
              </li>
              <li className="item">
                <a className="link" href="">Site feedback</a>
              </li>
            </ul>
          </li>
          <li className="footer-nav-col col col-4 col-sm-12">
    ...
    <div className="footer-end">
      <p className="copyright txt-center">DESIGN BY ICEO.CO - © 2019. ALL RIGHTS RESERVED.</p>
    </div>
  </footer>
  )
}
